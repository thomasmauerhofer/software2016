...
public class ManageQuestionsAdapter extends ArrayAdapter<QuestionCatalogItem> implements Filterable {
    ...
    public ManageQuestionsAdapter(Context context, int textViewResourceId,
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        convertView = layoutInflater.inflate(R.layout.list_manage_questions, parent, false);
