...
public class DBHelper extends SQLiteOpenHelper {
    ...
    private void insertInitialData(SQLiteDatabase dataBase) {
        ...
        TextQuestion textQuestion7 = new TextQuestion(7,"How many oscars did the Titanic movie got?", answer1, answer2, answer3, answer4, 2);
        ...
        TextQuestion textQuestion9 = new TextQuestion(9,"What is the name of the prison in the film The Rock?", answer1, answer2, answer3, answer4, 2);
        ...
        TextQuestion textQuestion13 = new TextQuestion(13,"What is the house number of the Simpsons?", answer1, answer2, answer3, answer4, 2);
